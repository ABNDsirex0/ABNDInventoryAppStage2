...
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://cloud.krzysztofkin.inventoryapp2/books" will map to the
        ...
        // For example, "content://cloud.krzysztofkin.inventoryapp2/books/3" matches, but
        // "content://cloud.krzysztofkin.inventoryapp2/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://cloud.krzysztofkin.inventoryapp2/books/3",
